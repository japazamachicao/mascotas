...
class Home extends Component
{
    public function getProviderData(User $user)
    {
        ...
        if ($user->hasRole('veterinarian') && $user->veterinarianProfile) {
            ...
            $data['price'] = $basePrice ?? $user->walkerProfile->hourly_rate ?? $user->walkerProfile->price_from;
            ...
            $data['price'] = $basePrice ?? $user->groomerProfile->price_from;
            ...
            $data['price'] = $basePrice ?? $user->hotelProfile->price_from;
            ...
            $data['price'] = $basePrice ?? $user->trainerProfile->price_from;

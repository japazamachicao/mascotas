    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            ...
            'storage_api_uri' => env('GOOGLE_CLOUD_STORAGE_API_URI', null), // see: Public endpoints
            'apiEndpoint' => env('GOOGLE_CLOUD_STORAGE_API_ENDPOINT', null), // set storage client apiEndpoint
